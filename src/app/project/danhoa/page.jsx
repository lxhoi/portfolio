  ...
  return (
    <div className="sample-project" ref={sampleProjectRef}>
      <section className="sp-hero">
        <Copy delay={0.85}>
          <h1>Đan Hoa Productions</h1>
        </Copy>
      </section>

      <section className="sp-banner-img">
        <img src="/images/work/danhoa/danhoa_1.png" alt="" />
      </section>
      ...
      <section className="sp-images">
        ...
        <div className="sp-images-container">
          ...
          <div className="sp-img">
            <img src="/images/work/danhoa/danhoa_2.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/danhoa/danhoa_3.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/danhoa/danhoa_4.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/danhoa/danhoa_5.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/danhoa/danhoa_6.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/danhoa/danhoa_7.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/danhoa/danhoa_8.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/danhoa/danhoa_1.png" alt="" />
          </div>
