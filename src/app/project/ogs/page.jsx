  ...
  return (
    <div className="sample-project" ref={sampleProjectRef}>
      ...
      <section className="sp-banner-img">
        <img src="/images/work/ogs/ogs_4.png" alt="" />
      </section>
      ...
      <section className="sp-images">
        ...
        <div className="sp-images-container">
          <div className="sp-img">
            <img src="/images/work/ogs/ogs_2.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/ogs/ogs_3.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/ogs/ogs_5.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/ogs/ogs_1.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/ogs/ogs_6.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/ogs/ogs_7.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/ogs/ogs_8.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/ogs/ogs_9.png" alt="" />
          </div>
        </div>
      </section>
