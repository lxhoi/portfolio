  ...
  return (
    <div className="sample-project" ref={sampleProjectRef}>
      <section className="sp-hero">
        <Copy delay={0.85}>
          <h1>2022 Logofolio</h1>
        </Copy>
      </section>

      <section className="sp-banner-img">
        <img src="/images/work/port22/port22_1.png" alt="" />
      </section>
        ...
        <div className="sp-copy-wrapper">
          ...
          <div className="sp-col-sm">
            <div className="sp-copy-description">
              <Copy>
                <p>
                  This logofolio is a curated collection of my branding and logo design work, 
                  showcasing how strategy and creativity come together to build 
                  memorable brand identities. Each mark is crafted with purpose—to tell a story, 
                  capture a vision, and create lasting impact.
                </p>
              </Copy>
      ...
      <section className="sp-images">
        ...
        <div className="sp-images-container">
          <div className="sp-img">
            <img src="/images/work/port22/port22_2.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/port22/port22_3.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/port22/port22_4.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/port22/port22_5.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/port22/port22_6.png" alt="" />
          </div>
        </div>
      </section>
        ...
        <div className="sp-next-project-copy">
          ...
          <div className="sp-next-project-names">
            <Copy>
              <h1
                style={{ cursor: "pointer" }}
                onClick={() => window.location.href = "/project/ogs"}
              >
                OGS.VN
              </h1>
            </Copy>
