  ...
  return (
    <div className="sample-project" ref={sampleProjectRef}>
      ...
      <section className="sp-banner-img">
        <img src="/images/work/kitals/kitals_1.png" alt="" />
      </section>
        ...
        <div className="sp-copy-wrapper">
          <div className="sp-col-lg">
            <div className="sp-copy-title">
              <Copy>
                <h3>Kitals: Powering Stories in Gaming</h3>
              </Copy>
            </div>
          </div>
          <div className="sp-col-sm">
            <div className="sp-copy-description">
              <Copy>
                <p>
                  The Kitals brand identity was created to reflect 
                  its specialization in video game communications.
                </p>
                <br />
                <p>
                  The design balances professionalism with creativity, 
                  capturing the agency’s role as both a trusted partner 
                  for organizations and a dynamic player in the gaming industry.
                </p>
              </Copy>
      ...
      <section className="sp-images">
        ...
        <div className="sp-images-container">
          <div className="sp-img">
            <img src="/images/work/kitals/kitals_3.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/kitals/kitals_4.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/kitals/kitals_5.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/kitals/kitals_6.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/kitals/kitals_7.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/kitals/kitals_8.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/kitals/kitals_1.png" alt="" />
          </div>
                                ...
                                <div className="sp-next-project-copy">
                                  ...
                                  <div className="sp-next-project-names">
                                    <Copy>
                                      <h1
                                        style={{ cursor: "pointer" }}
                                        onClick={() => window.location.href = "/project/port23"}
                                      >
                                        2023 Logofolio
                                      </h1>
                                    </Copy>
