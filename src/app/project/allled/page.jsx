  ...
  return (
    <div className="sample-project" ref={sampleProjectRef}>
      <section className="sp-hero">
        <Copy delay={0.85}>
          <h1>Allled Vietnam</h1>
        </Copy>
      </section>

      <section className="sp-banner-img">
        <img src="/images/work/allled/allled_1.png" alt="" />
      </section>
      ...
      <section className="sp-images">
        ...
        <div className="sp-images-container">
          <div className="sp-img">
            <img src="/images/work/allled/allled_2.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/allled/allled_3.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/allled/allled_4.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/allled/allled_5.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/allled/allled_6.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/allled/allled_7.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/allled/allled_1.png" alt="" />
          </div>
