  ...
  return (
    <div className="sample-project" ref={sampleProjectRef}>
      ...
      <section className="sp-banner-img">
        <img src="/images/work/ttp/ttp_1.png" alt="" />
      </section>
      ...
      <section className="sp-images">
        ...
        <div className="sp-images-container">
          ...
          <div className="sp-img">
            <img src="/images/work/ttp/ttp_2.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/ttp/ttp_3.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/ttp/ttp_4.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/ttp/ttp_5.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/ttp/ttp_7.png" alt="" />
          </div>
        </div>
      </section>
