  ...
  return (
    <div className="sample-project" ref={sampleProjectRef}>
      ...
      <section className="sp-banner-img">
        <img src="/images/work/port24/port24_7.png" alt="" />
      </section>
      ...
      <section className="sp-images">
        ...
        <div className="sp-images-container">
          <div className="sp-img">
            <img src="/images/work/port24/port24_1.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/port24/port24_2.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/port24/port24_3.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/port24/port24_4.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/port24/port24_5.png" alt="" />
          </div>
        </div>
      </section>
