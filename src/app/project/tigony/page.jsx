  ...
  return (
    <div className="sample-project" ref={sampleProjectRef}>
      <section className="sp-hero">
        <Copy delay={0.85}>
          <h1>Tigony Interiors</h1>
        </Copy>
      </section>

      <section className="sp-banner-img">
        <img src="/images/work/tigony/tigony_2.png" alt="" />
      </section>
      ...
      <section className="sp-images">
        ...
        <div className="sp-images-container">
          <div className="sp-img">
            <img src="/images/work/tigony/tigony_7.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/tigony/tigony_9.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/tigony/tigony_6.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/tigony/tigony_5.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/tigony/tigony_4.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/tigony/tigony_3.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/tigony/tigony_2.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/tigony/tigony_1.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/tigony/tigony_8.png" alt="" />
          </div>
        </div>
      </section>
