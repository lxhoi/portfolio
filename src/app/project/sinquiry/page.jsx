  ...
  return (
    <div className="sample-project" ref={sampleProjectRef}>
      ...
      <section className="sp-banner-img">
        <img src="/images/work/sinquiry/sinquiry_1.png" alt="" />
      </section>
      ...
      <section className="sp-images">
        ...
        <div className="sp-images-container">
          <div className="sp-img">
            <img src="/images/work/sinquiry/sinquiry_2.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/sinquiry/sinquiry_4.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/sinquiry/sinquiry_5.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/sinquiry/sinquiry_6.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/sinquiry/sinquiry_3.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/sinquiry/sinquiry_7.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/sinquiry/sinquiry_8.png" alt="" />
          </div>
        </div>
      </section>
