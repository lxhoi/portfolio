  ...
  return (
    <div className="sample-project" ref={sampleProjectRef}>
      <section className="sp-hero">
        <Copy delay={0.85}>
          <h1>Topazio Phuc Yen</h1>
        </Copy>
      </section>

      <section className="sp-banner-img">
        <img src="/images/work/topazio/topazio_3.png" alt="" />
      </section>
        ...
        <div className="sp-copy-wrapper">
          <div className="sp-col-lg">
            <div className="sp-copy-title">
              <Copy>
                <h3>Topazio - Refined Living Inspired by the Guardian Gem</h3>
              </Copy>
            </div>
          </div>
          <div className="sp-col-sm">
            <div className="sp-copy-description">
              <Copy>
                <p>
                  Topazio is an apartment project, inspired by the honed Topaz guardian gem. 
                  Topazio apartments are streamlined but comfortable to meet a modern dynamic lifestyle but elegant sophistication.
                </p>
              </Copy>
      ...
      <section className="sp-images">
        ...
        <div className="sp-images-container">
          <div className="sp-img">
            <img src="/images/work/topazio/topazio_1.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/topazio/topazio_2.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/topazio/topazio_3.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/topazio/topazio_4.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/topazio/topazio_5.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/topazio/topazio_6.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/topazio/topazio_7.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/topazio/topazio_8.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/topazio/topazio_9.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/topazio/topazio_10.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/topazio/topazio_11.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/topazio/topazio_12.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/topazio/topazio_13.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/topazio/topazio_14.png" alt="" />
          </div>
        </div>
      </section>
        ...
        <div className="sp-next-project-copy">
          ...
          <div className="sp-next-project-names">
            <Copy>
              <h1
                style={{ cursor: "pointer" }}
                onClick={() => window.location.href = "/project/ttp"}
              >
                TTP Foods
              </h1>
            </Copy>
